...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 16, 4);
 	...
 	ivoc_help("help ?1 CO C:/Users/bensr/Documents/GitHub/NeuroGPU/UrapNeuron/Markov2st/co.mod\n");
...
static void initmodel(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {
  ...
  o = o0;
 {
    _ss_sparse_thread(&_thread[_spth1]._pvoid, 2, _slist1, _dlist1, _p, &t, dt, states, _linmat1, _ppvar, _thread, _nt);
  }
 ...
 v=_v;
{
 ...
 { {
 for (; t < _break; t += dt) {
  sparse_thread(&_thread[_spth1]._pvoid, 2, _slist1, _dlist1, _p, &t, dt, states, _linmat1, _ppvar, _thread, _nt);
