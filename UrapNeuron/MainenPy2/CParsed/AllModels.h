...
#define CALL_TO_BREAK_DV_STR_CU(VARILP)    if(cBoolModel[PIdx_ ## VARILP +0*InMat.N]){CuBreakpointModel_ca(sumCurrentsDv, sumConductivityDv,  V[seg]+0.001,ModelStates_ ## VARILP[0],ModelStates_ ## VARILP[1],param_macro(0, PIdx_ ## VARILP) ,param_macro(1, PIdx_ ## VARILP) , ModelStates_ ## VARILP[8] , ModelStates_ ## VARILP[9] );}if(cBoolModel[PIdx_ ## VARILP +1*InMat.N]){CuBreakpointModel_cad(sumCurrentsDv, sumConductivityDv,  V[seg]+0.001,ModelStates_ ## VARILP[2], ModelStates_ ## VARILP[9] , ModelStates_ ## VARILP[8] );}if(cBoolModel[PIdx_ ## VARILP +2*InMat.N]){CuBreakpointModel_kca(sumCurrentsDv, sumConductivityDv,  V[seg]+0.001,ModelStates_ ## VARILP[3],param_macro(2, PIdx_ ## VARILP) ,param_macro(3, PIdx_ ## VARILP) ,param_macro(4, PIdx_ ## VARILP) ,param_macro(5, PIdx_ ## VARILP) , ModelStates_ ## VARILP[8] );}if(cBoolModel[PIdx_ ## VARILP +3*InMat.N]){CuBreakpointModel_km(sumCurrentsDv, sumConductivityDv,  V[seg]+0.001,ModelStates_ ## VARILP[4],param_macro(6, PIdx_ ## VARILP) ,param_macro(7, PIdx_ ## VARILP) ,param_macro(8, PIdx_ ## VARILP) ,param_macro(9, PIdx_ ## VARILP) ,param_macro(10, PIdx_ ## VARILP) );}if(cBoolModel[PIdx_ ## VARILP +4*InMat.N]){CuBreakpointModel_kv(sumCurrentsDv, sumConductivityDv,  V[seg]+0.001,ModelStates_ ## VARILP[5],param_macro(11, PIdx_ ## VARILP) ,param_macro(12, PIdx_ ## VARILP) ,param_macro(13, PIdx_ ## VARILP) ,param_macro(14, PIdx_ ## VARILP) ,param_macro(15, PIdx_ ## VARILP) );}if(cBoolModel[PIdx_ ## VARILP +5*InMat.N]){CuBreakpointModel_na(sumCurrentsDv, sumConductivityDv,  V[seg]+0.001,ModelStates_ ## VARILP[6],ModelStates_ ## VARILP[7],param_macro(16, PIdx_ ## VARILP) ,param_macro(17, PIdx_ ## VARILP) ,param_macro(18, PIdx_ ## VARILP) ,param_macro(19, PIdx_ ## VARILP) ,param_macro(20, PIdx_ ## VARILP) ,param_macro(21, PIdx_ ## VARILP) ,param_macro(22, PIdx_ ## VARILP) ,param_macro(23, PIdx_ ## VARILP) ,param_macro(24, PIdx_ ## VARILP) ,param_macro(25, PIdx_ ## VARILP) ,param_macro(26, PIdx_ ## VARILP) ,param_macro(27, PIdx_ ## VARILP) );}
