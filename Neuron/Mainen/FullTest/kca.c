...
#define q10 q10_kca
 double q10 = 2.3;
#define tadj_kca _thread1data[0]
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 5);
 	...
 	ivoc_help("help ?1 kca C:/Users/rben.KECK-CENTER/Documents/neurogpu2/Neuron/Mainen/FullTest/kca.mod\n");
...
static int  rates ( _p, _ppvar, _thread, _nt, _lcai ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lcai ;
 {
   a = Ra * pow( _lcai , caix ) ;
   b = Rb ;
