	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 na /cygdrive/c/Users/Roy/Documents/NeuroGPU2/Neuron/printCell/ForC/knacaonly/na.mod\n");
...
double trap0 ( _p, _ppvar, _thread, _nt, _lv , _lth , _la , _lq ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
