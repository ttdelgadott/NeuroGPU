...
extern int nrn_get_mechtype();
 ...
 "efun_car", _hoc_efun,
 "evaluatefct_car", _hoc_evaluatefct,
 "ghk_car", _hoc_ghk,
 "nongat_car", _hoc_nongat,
 0, 0
};
#define efun efun_car
#define ghk ghk_car
#define nongat nongat_car
 extern double efun();
 extern double ghk();
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 5);
 	...
 	ivoc_help("help ?1 car /Users/alon/Neuron/mara/stage2_bk_inact_line/Demo/x86_64/ca_r.mod\n");
...
static int  evaluatefct ( _p, _ppvar, _thread, _nt, _lv ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv ;
 {
   minf = 1.0 / ( 1.0 + exp ( - ( _lv + shift + 23.0 ) / 7.4 ) ) ;
   hinf = 1.0 / ( 1.0 + exp ( ( _lv + shifth + 79.0 ) / 7.8 ) ) ;
   taum = ( 5.5 / ( cosh ( 0.032 * ( _lv + shift + 23.0 ) ) ) ) / phim ;
   tauh = ( 771.0 / ( cosh ( 0.047 * ( _lv + shifth + 79.0 ) ) ) ) / phih ;
    return 0; }
