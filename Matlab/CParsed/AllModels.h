...
#define CALL_TO_KINETIC  if(TheMMat.boolModel[seg+0*TheMMat.N]){} if(TheMMat.boolModel[seg+1*TheMMat.N]){} if(TheMMat.boolModel[seg+2*TheMMat.N]){} if(TheMMat.boolModel[seg+3*TheMMat.N]){} if(TheMMat.boolModel[seg+4*TheMMat.N]){} if(TheMMat.boolModel[seg+5*TheMMat.N]){}
