function [hasThisModel vars_MainenKv varsForModelAllSegs consts_MainenKv isElectrodeCurrent] = ...
    AmitInitModel_kv(hasThisModel, vars_MainenKv, varsForModelAllSegs, consts_MainenKv, constsAllModelsAllSegs, Vs,...
...
for segInd=2:3
    ...
    [vars_MainenKv(segInd,:), varsForModelAllSegs] = kv_trates (vars_MainenKv(segInd,:), ...
        varsForModelAllSegs, consts_MainenKv, constsAllModelsAllSegs, Vs(segInd));
%     vars_MainenKv(segInd,:) = Amit_trates_MainenKv (vars_MainenKv(segInd,:), consts_MainenKv,...
%         Vs(segInd));              %QWERTY - to be deleted
