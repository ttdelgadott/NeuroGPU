	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 it C:/Users/rben.KECK-CENTER/Documents/Lab/GPUAnalysis/Neuron/NewModelCA/CaT.mod\n");
...
static int  rates ( _p, _ppvar, _thread, _nt, _lv_ ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv_ ;
 {
   double _la , _lb ;
