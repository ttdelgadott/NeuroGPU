...
#define h _mlhh
 ...
 static int _hoc_fun3();
 static int _hoc_fun2();
 static int _hoc_fun1();
 static int _hoc_min();
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 kc /cygdrive/c/Users/Roy/Documents/NeuroGPU2_2/Neuron/printCell/Amit/kc.mod\n");
...
double fun1 ( _p, _ppvar, _thread, _nt, _lv , _lV0 , _lA , _lB ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv , _lV0 , _lA , _lB ;
 {
   double _lfun1;
...
double fun2 ( _p, _ppvar, _thread, _nt, _lv , _lV0 , _lA , _lB ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv , _lV0 , _lA , _lB ;
 {
   double _lfun2;
...
double fun3 ( _p, _ppvar, _thread, _nt, _lv , _lV0 , _lA , _lB ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv , _lV0 , _lA , _lB ;
 {
   double _lfun3;
...
double min ( _p, _ppvar, _thread, _nt, _lx , _ly ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lx , _ly ;
 {
   double _lmin;
 if ( _lx <= _ly ) {
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ik = ( 1e-3 ) * gkbar * min ( _threadargscomma_ cai / 250.0 , 1.0 ) * c * ( v - ek ) ;
   }
 _current += ik;
