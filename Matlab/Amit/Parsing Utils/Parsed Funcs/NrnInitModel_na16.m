function [constsPerModelPerSeg, constsPerModelAllSeg, varsPerModelPerSeg, varsPerModelAllSeg, varsAllModelPerSeg] = NrnInitModel_na16 (constsAllModelAllSeg, varsAllModelPerSeg, hasThisModel, vs, nSegs)
...
constsPerModelAllSeg(qa_index)   = 6			;
