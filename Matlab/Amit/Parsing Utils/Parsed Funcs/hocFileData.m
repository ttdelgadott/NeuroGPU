...
ModelsFuncsNames(7,:) = strcat(ModelsFuncsNames(7,:), 'pas');
ModelsFuncsNames(8,:) = strcat(ModelsFuncsNames(8,:), 'stim');

hasModel = zeros (NUM_OF_SEGS, NUM_OF_MODELS);
for segInd = 2:2
    hasModel(segInd, [1  2  3  4  5  6  7]) = 1;
end
for segInd = 4:14
    hasModel(segInd, [1  2  3  4  6  7]) = 1;
end
for segInd = 16:16
    hasModel(segInd, [1  2  3  4  6  7]) = 1;
end
...
for segInd = 391:391
    hasModel(segInd, [5  6  7]) = 1;
end
for segInd = 393:393
    hasModel(segInd, [5  6  7]) = 1;
end
for segInd = 395:395
    hasModel(segInd, [6  7]) = 1;
end
for segInd = 397:397
    hasModel(segInd, [6  7]) = 1;
end
