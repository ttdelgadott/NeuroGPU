...
function [rhss dg constsAndVars] = nrnRhs (rhss, dg, t, Vs, hasModel,...
    ...
    for segInd=1:nSegs
        if hasModel(segInd, modelInd)
            ...
            [rhsForModel dgForThisModel constsAndVars.varsPerModelPerSeg{modelInd}(segInd, :) ...
                constsAndVars.varsPerModelAllSeg{modelInd} constsAndVars.varsAllModelPerSeg(segInd, :)] = nrnCur(t, Vs(segInd),...
