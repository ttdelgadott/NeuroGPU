...
#define CALL_TO_KINETIC_CU(VARILP)  if(cBoolModel[PIdx_ ## VARILP +0*InMat.N]){} if(cBoolModel[PIdx_ ## VARILP +1*InMat.N]){} if(cBoolModel[PIdx_ ## VARILP +2*InMat.N]){} if(cBoolModel[PIdx_ ## VARILP +3*InMat.N]){} if(cBoolModel[PIdx_ ## VARILP +4*InMat.N]){} if(cBoolModel[PIdx_ ## VARILP +5*InMat.N]){}
